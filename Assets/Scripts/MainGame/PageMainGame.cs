...
public class PageMainGame : MonoBehaviour {
    public static PageMainGame Instance;
...
//#endif
    ...
    void CreateCharacters()
    {
        ...
        Vector3 pointHero = new Vector3(0, Modules.pointHeroTerrain + 0.3f, 2);
        ...
        foreach (GameObject go in Modules.listHeroUse)
        {
            ...
            if (heroCon.idHero == codeNow)
            {
                ...
                Modules.mainCharacter.transform.rotation = Quaternion.Euler(new Vector3(0,245f, 0f));
                HeroController heroNow = Modules.mainCharacter.GetComponent<HeroController>();
        ...
        Vector3 pointPoliceCarNew = new Vector3(pointPoliceCar.x, pointPoliceCar.y + Modules.pointHeroTerrain, pointPoliceCar.z+2);
     ...
     //   }
       ...
       // Modules.SetModelUseItem(Modules.mainCharacter.transform, heroControl.codeBody, heroControl.mySkis, "Skis");
        ...
        Vector3 pointStartEnemyLeftNew = new Vector3(pointStartEnemyLeft.x, pointStartEnemyLeft.y+0.5f + Modules.pointHeroTerrain, pointStartEnemyLeft.z);
    ...
    [HideInInspector]
   // public GameObject createEnemyLeft;
