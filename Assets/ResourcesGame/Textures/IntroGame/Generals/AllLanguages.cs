...
public class AllLanguages : MonoBehaviour {
    ...
    public static string gameName = "Presidential Race";
    ...
    {
        "Share this game with your friends on your Facebook page to unlock <color=green>Joey</color> for free.",
        "Расскажи друзьям об игре на своей странице в Фейсбуке, чтобы бесплатно разблокировать <color=green>Louis</color>.",
        "Partage ce jeu sur Facebook pour débloquer le personnage <color=green>Joey</color> gratuitement.",
        "Teilen sie dieses Spiel mit Ihren Freunden auf Facebook, um <color=green>Joey</color> Charakter gratis freizuschalten.",
        "Comparta este juego con sus amigos de Facebook para desbloquear el personaje <color=green>Joey</color> gratis.",
        "Compartilhe este jogo com seus amigos do Facebook para desbloquear o personagem <color=green>Joey</color> gratuitamente.",
        ...
        "在您的面子 书页面上与您 的朋友分享此游戏， 以免费解锁 <color=green>Joey</color>。",
        "Chia sẻ trò chơi này trên Facebook của bạn để mở khóa nhân vật <color=green>Joey</color> miễn phí."
    };
    ...
    public static List<string> menuNoteInvite = new List<string>() 
    {
        ...
        "Envíe invitaciones a sus amigos <color=green>(" + Modules.coinBonusInvite + " Monedas/ amigo)</color>. Cuantos más amigos invite, más diamantes recibirá.", 
        "Envie convites para seus amigos <color=green>(" + Modules.coinBonusInvite + " Monedas/ amigo)</color>. Quanto mais amigos você convidar,mais diamantes você receberá.", 
    ...
    {
        "You get <color=orange>5000</color> coins and unlock the <color=green>Hunny Bunny</color> for the first time play.",
        ...
        "Usted consigue <color=orange>5000</color> monedas y desbloquea el <color=green>Hunny Bunny</color> para jugar por 1ª vez.",
        "Você ganha <color=orange>5000</color> monedas e desbloqueia o <color=green>Hunny Bunny</color> pela primeira vez.",
    ...
    public static List<List<string>> heroInfoHero = new List<List<string>>() { 
        ...
        new List<string>()
        {
            ...
            "Nom: Joey\nMale\nAmerican\n77 ans\nTaille: 6' 0''\nLoisirs: Football",
            "Name: Joey\nMale\nAmerican\n77 Jahre alt\nGröße: 6' 0''\nHobby: Football",
            "Nombre: Joey\nMale\nAmerican\n77 años\nAltura: 6' 0''\nPasatiempos: Football",
            "Nome: Joey\nMale\nAmerican\n77 anos\nAltura: 6' 0''\nPassatempos: Football",
            "الاسم: Joey\nMale \nAmerican\n77 سنة /nالطول: 6' 0'' inch \nالهوايات: football",
            "名前：Joey\nMale\nAmerican\n77 歳\n身長：6' 0''\n趣味： Football",
            "이름 : Joey\nMale\nAmerican\n77 세\n높이 : 6' 0''\n취미 : Football",
            "姓名：Joey\nMale\nAmerican\n77\n6' 0'' 厘米\n爱好： Football",
            "Tên: Joey\nMale \nAmerican\n77 tuổi\nCao: 6' 0''\nSở thích: Football"
    ...
    { 
        "coins right after purchase.", 
        "БРИЛЛИАНТОВ сразу после покупки.", 
        "pièces après l'achat.", 
        "münzen nach dem Kauf haben.", 
        "monedas justo después de la compra.", 
        "monedas logo após a compra.", 
    ...
    { 
        "Get a chance to win coins, keys, hoverboards and more.", 
